<nav class="navbar navbar-expand-lg bg-body-tertiary" id="navBootstrap" style="display:none">
  <div class="container-fluid">
    <a class="navbar-brand" href="#" id="navTitle">Navbar</a>
...
<nav class="bg-white border-gray-200 dark:bg-gray-900" id="navTailwind" style="display:none">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://flowbite.com/" class="flex items-center">
        <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" id="navTitle">Flowbite</span>
    </a>
